...
def run(
    weights,source=None,device='cpu',view_img=False,save_img=False,save_video=True,exist_ok=False,
    line_thickness=2,
    ):
...
# Example usage
weights_path_behavior = "/home/pi/Desktop/Raspberry Pi/bestFFFF.pt"
video_path_behavior = "/home/pi/Desktop/Raspberry Pi/Test_1.mp4"

#run(weights=weights_path_behavior, source=video_path_behavior, device='cpu', view_img=True, save_img=False, save_video=True)
result_counts = run(weights=weights_path_behavior, source=video_path_behavior, device='cpu', view_img=True, save_img=False, save_video=True)
