...
def run(
    weights=(r"C:\Users\theekshana\Desktop\Project-Fish-ML\Project-Fish-ML\Function 3\Task-1(Identify The Type of Fish and Count)\best.pt"),
    source=None,
    device='cpu',
    view_img=False,
    save_img=False,
    ...
    # Output setup
    save_dir = increment_path(Path('/path/to/output') / 'exp', exist_ok)
...
weights_path = (r"C:\Users\theekshana\Desktop\Project-Fish-ML\Project-Fish-ML\Function 3\Task-1(Identify The Type of Fish and Count)\best.pt")
video_path = (r"C:\Users\theekshana\Desktop\Test Dataset\A.webm")

run(weights=weights_path, source=video_path, device='cpu', view_img=False, save_img=False, save_video=True)
